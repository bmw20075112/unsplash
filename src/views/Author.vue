<template>
  <div class="author-page-wrapper">
    <section class="author-intro">
      ...
      <div class="author-info">
        ...
        <div class="icon-group">
          <i
            class="fab fa-instagram-square social-link"
            v-if="authorInfo.instagram_username"
          >
            <a
              :href="instagramUrl"
              target="_blank"
          ...
          <i
            class="fab fa-twitter-square social-link"
            v-if="authorInfo.twitter_username"
          >
            <a
              :href="twitterUrl"
              target="_blank"
          ...
          <i
            class="fas fa-globe-americas social-link"
            v-if="authorInfo.portfolio_url"
          >
            <a
              :href="authorInfo.portfolio_url"
              target="_blank"
              rel="noopener noreferrer"
              class="social-link-text"
            >
    ...
    <h3 class="collection-name">
      {{ authorInfo.first_name }}'s Photos
    </h3>
    <hr class="cutLine">
